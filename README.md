...
The frontend and backend are maintained in separate repositories and deployed as separate services. This repository contains the [React client](https://github.com/tombryson/burning-airlines-client); the [Rails API and PostgreSQL data model](https://github.com/tombryson/burning-airlines-backend) live in the backend repository.
...
From the backend repository directory, `burning-airlines-backend`:
...
From this frontend repository directory, `burning-airlines-client`:
